...
<ul class="navbar-nav">
	...
	<li class="nav-item d-none d-sm-inline-block"><a href="/login" class="nav-link">HOME</a></li>
	<li class="nav-item d-none d-sm-inline-block"><a href="/login" class="nav-link">회원관리</a></li>
</ul>
